...
from losses.dice import GeneralizedDiceLoss, expand_as_one_hot
...
class Solver(object):
    ...
    def build_model(self):
        if self.model_type == 'VNet':
            ...
            self.net.load_state_dict(
                torch.load('/mnt/HDD/datasets/competitions/vnet/models_for_cls/VNet-400-0.0001000-200-0.5000-ce-400-200-vnet-dice+ce.pkl')
            )
    ...
    def train(self, epoch):
        ...
        for i, (imgs, gts) in enumerate(tqdm(self.train_loader)):
            ...
            dice_loss = GeneralizedDiceLoss(sigmoid_normalization=False)(outputs, expand_as_one_hot(gts.reshape(-1,128,128,128),14))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--comment', type=str, default='ce-100-50-vnet-dice+ce-then-generalizeddice-1')
