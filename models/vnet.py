...
class OutputTransition(nn.Module):
    def __init__(self, inChans, elu, nll):
        ...
        self.conv1 = nn.Conv3d(inChans, 32, kernel_size=5, padding=2)
        self.bn1 = ContBatchNorm3d(32)
        self.conv2 = nn.Conv3d(32, 14, kernel_size=1) # 2
        self.relu1 = ELUCons(elu, 14) # 2
        # if nll:
