...
def main(config):
    ...
    train_set = UnetSet(config.train_path, fold=5 )
    valid_set = UnetSet(config.valid_path,is_train=False,fold=5)
    test_set = UnetSet(config.test_path,is_train=False, fold=5)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--num_epochs', type=int, default=250)  # random hyperparam search
    parser.add_argument('--num_epochs_decay', type=int, default=100)  # random hyperparam search
    ...
    parser.add_argument('--comment', type=str, default='uu-21-fold5')
