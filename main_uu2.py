...
class Solver(object):
    ...
    def build_model(self):
        if self.model_type == 'UNet':
            ...
            self.net.load_state_dict(torch.load('/mnt/HDD/datasets/competitions/unet/models_for_cls/UNet-100-0.0001000-50-0.5000-uu-fold1-contrast.pkl'))
    ...
    def train(self, epoch):
        ...
        for i, (img, prob , gt) in enumerate(tqdm(self.train_loader)):
            ...
            dice_loss = DiceLoss(sigmoid_normalization=False)(outputs, expand_as_one_hot(gt.reshape(-1,256,256),23))
...
if __name__ == '__main__':
    ...
    # misc
    data_root = '/mnt/HDD/datasets/competitions/set4unet'
    ...
    parser.add_argument('--comment', type=str, default='uu-fold1-2')
