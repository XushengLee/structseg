...
#        self.criterion = FocalLoss(alpha=0.8,gamma=0.5)  # torch.nn.BCELoss()
    ...
    def train(self, epoch):
        ...
        for i, (imgs, gts) in enumerate(tqdm(self.train_loader)):
            ...
            focal_loss = FocalLoss(num_class=14,alpha=None,gamma=1)(outputs, gts.reshape(-1,128,128,128))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--comment', type=str, default='ce-400-200-vnet-generalizeddice')
