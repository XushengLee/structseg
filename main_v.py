...
class Solver(object):
    ...
    def train(self, epoch):
        ...
        for i, (imgs, gts) in enumerate(tqdm(self.train_loader)):
            ...
            # dice_loss = DiceLoss()(outputs.view(outputs.size(0), -1), gts.view(gts.size(0), -1))
    ...
    def validation(self, epoch):
        ...
        if (epoch+1)%50 == 0 and epoch!=1:
            torch.save(self.net.state_dict(), 'epoch{}.pkl'.format(epoch+1))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--comment', type=str, default='ce-400-200-vnet-ce')
